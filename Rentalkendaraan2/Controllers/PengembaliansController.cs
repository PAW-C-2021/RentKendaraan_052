...
namespace Rentalkendaraan2.Controllers
{
    public class PengembaliansController : Controller
    {
        ...
        public PengembaliansController(RentalKendaraankuContext context)
        {
            _context = context;
        }
        ...
        {
            var rentalKendaraankuContext = _context.Pengembalian.Include(p => p.IdKondisiNavigation).Include(p => p.IdPeminjamanNavigation);
