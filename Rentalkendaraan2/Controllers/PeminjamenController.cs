...
using Rentalkendaraan2.Models;

namespace Rentalkendaraan2.Controllers
{
    public class PeminjamenController : Controller
    {
        private readonly RentalKendaraankuContext _context;

        public PeminjamenController(RentalKendaraankuContext context)
        {
            _context = context;
        }
        ...
        {
            var rentalKendaraankuContext = _context.Peminjaman.Include(p => p.IdCostumerNavigation).Include(p => p.IdJaminanNavigation).Include(p => p.IdKendaraanNavigation);
            return View(await rentalKendaraankuContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjamaan,IdKendaraan,IdCostumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPeminjaman,TglPeminjamaan,IdKendaraan,IdCostumer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
