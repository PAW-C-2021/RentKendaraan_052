...
{
    public partial class RentalKendaraankuContext : DbContext
    {
        public RentalKendaraankuContext()
        {
        }

        public RentalKendaraankuContext(DbContextOptions<RentalKendaraankuContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Peminjaman>(entity =>
            {
                ...
                entity.Property(e => e.TglPeminjamaan)
                    .HasColumnName("Tgl_Peminjamaan")
